...
public class CircleSeekBar extends View {
    ...
    private float mSeekBarDegree = 45;
    ...
    protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(DEBUG) Log.d(TAG, "width:"+mViewWidth+"");
...
//                mSeekBarBackgroundPaint);
        canvas.drawArc(mArcRectF,45,90,false,mSeekBarBackgroundPaint);
        canvas.drawArc(this.mArcRectF, 45F, mSeekBarDegree, false, mSeekbarProgressPaint);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                Log.d(TAG, "mSeekBarDegree = " + mSeekBarDegree);
                seekTo(eventX, eventY, false);
                break ;
...
//            }
            ...
            if (mSeekBarDegree <45){
                mSeekBarDegree = 45;
                return;
            }
            if (mSeekBarDegree > 135){
                mSeekBarDegree = 135;
                return;
            }
            ...
            mCurrentProgress = (int) (mSeekBarMax * mSeekBarDegree / 90);
    ...
    public synchronized void setProgress(int progress) {
        ...
        mSeekBarDegree = (progress * 90 / mSeekBarMax);
